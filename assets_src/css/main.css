...
.bg-gradient-primary {
    background:#430644;
    background:-webkit-linear-gradient(140deg,#cf01d2 25%,#430644 100%);
    background:-moz-linear-gradient(140deg,#cf01d2 25%,#430644 100%);
    background:-ms-linear-gradient(140deg,#cf01d2 25%,#430644 100%);
    background:-o-linear-gradient(140deg,#cf01d2 25%,#430644 100%);
    background:linear-gradient(140deg,#cf01d2 25%,#430644 100%)
}
.bg-gradient-blue {
    background:#0957d9;
...
.shadow-l {
    -webkit-box-shadow:0 32px 40px rgba(0,0,0,.1);
    -moz-box-shadow:0 32px 40px rgba(0,0,0,.1);
    box-shadow:0 32px 40px rgba(0,0,0,.1)
}
.shadow-none {
...
.button.button-primary {
    background:#a0f;
    background:-webkit-linear-gradient(140deg,#fb00ff 25%,#a0f 100%);
    background:-moz-linear-gradient(140deg,#fb00ff 25%,#a0f 100%);
    background:-ms-linear-gradient(140deg,#fb00ff 25%,#a0f 100%);
    background:-o-linear-gradient(140deg,#fb00ff 25%,#a0f 100%);
    background:linear-gradient(140deg,#fb00ff 25%,#a0f 100%);
    -webkit-box-shadow:0 1px 3px rgba(0,0,0,.1);
    -moz-box-shadow:0 1px 3px rgba(0,0,0,.1);
    box-shadow:0 1px 3px rgba(0,0,0,.1);
    color:#fff
...
.button.button-primary:hover {
    background:#fb00ff;
    background:-webkit-linear-gradient(140deg,#fb00ff 25%,#fb00ff 100%);
    background:-moz-linear-gradient(140deg,#fb00ff 25%,#fb00ff 100%);
    background:-ms-linear-gradient(140deg,#fb00ff 25%,#fb00ff 100%);
    background:-o-linear-gradient(140deg,#fb00ff 25%,#fb00ff 100%);
    background:linear-gradient(140deg,#fb00ff 25%,#fb00ff 100%);
    -webkit-box-shadow:0 8px 16px rgba(0,0,0,.1);
    -moz-box-shadow:0 8px 16px rgba(0,0,0,.1);
    box-shadow:0 8px 16px rgba(0,0,0,.1);
...
iv_app-logo:hover {
    filter: invert(16%) sepia(91%) saturate(3892%) hue-rotate(290deg) brightness(110%) contrast(127%)!important;
    transition: all 0.6s;
}

iv_app-logo.light {
    background-image: url(/assets/media/TextLogo2.svg);
    filter: invert(100%) sepia(0%) saturate(7453%) hue-rotate(291deg) brightness(109%) contrast(100%);
}

iv_app-logo.dark {
    background-image: url(/assets/media/TextLogo2.svg);
    filter: invert(0%) sepia(4%) saturate(0%) hue-rotate(360deg) brightness(94%) contrast(100%);
}
